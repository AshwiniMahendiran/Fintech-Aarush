...
stock_data = {}
financial_data = {}
project_url = "https://data.disassemble46.hasura-app.io/"

# Keep your token secret
headers = {"Content-Type":"application/json", "Authorization":"Bearer permissiveness-conditioned-squatness-telic"}
